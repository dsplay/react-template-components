...
var GridGallery = function (_a) {
    ...
    var _e = React.useState(), containerWidth = _e[0], setContainerWidth = _e[1];
    var _f = React.useState(), containerHeight = _f[0], setContainerHeight = _f[1];
    var _g = React.useState(), convertedImages = _g[0], setProcessedImages = _g[1];
    ...
    var finalImages = React.useMemo(function () {
    ...
    if (!finalImages) {
        return (React__default['default'].createElement("div", { className: "" + containerClassName, ref: element, style: {
                width: '100%',
                height: '100%',
            } }));
    }
    return (React__default['default'].createElement("div", { className: "grid-gallery " + containerClassName, style: {
            width: '100%',
            height: '100%',
        } }, finalImages.map(function (image) { return (React__default['default'].createElement("div", { key: image.id, className: imageClassName + " gallery-item", style: __assign(__assign({}, image), { backgroundImage: "url('" + image.src + "')" }) })); })));
};
